...
class TensorflowUNet:
  ...
  def create(self, num_classes, image_height, image_width, image_channels,
    ...
    for i in range(num_layers):
      ...
      # 2023/06/20
      if normalization:
        print("-- Eecoder BatchNormalization {} 1".format(i))
      ...
      # 2023/06/25
      if normalization:
        print("-- Eecoder BatchNormalization {} 2".format(i))
    ...
    for i in range(num_layers-1):
      ...
      # 2023/06/20
      if normalization:
        print("-- Decoder BatchNormalization {} 1".format(i))
      ...
      # 2023/06/25
      if normalization:
        print("-- Decoder BatchNormalization {} 2".format(i))
        u = BatchNormalization()(u) 
      c  = u
